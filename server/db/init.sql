...
CREATE TABLE projects (
    ...
    logo_url TEXT,
    plot_area NUMERIC(15, 2) DEFAULT 0,
    reservation_area NUMERIC(15, 2) DEFAULT 0,
    amenities_area NUMERIC(15, 2) DEFAULT 0,
    open_space_area NUMERIC(15, 2) DEFAULT 0,
    sanctioned_fsi NUMERIC(15, 2) DEFAULT 0,
    tdr NUMERIC(15, 2) DEFAULT 0,
    rcc_slab_area NUMERIC(15, 2) DEFAULT 0,
    built_up_area NUMERIC(15, 2) DEFAULT 0,
    saleable_area NUMERIC(15, 2) DEFAULT 0,
    building_configurations TEXT,
    na_order_no TEXT,
    building_permit_cc_no TEXT,
    fire_emergency_dept TEXT,
    created_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
